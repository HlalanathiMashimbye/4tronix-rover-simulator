...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile bottom tab bar: four flat, equal-weight slots. Three are
          destinations (Home, Challenges, History) and the fourth opens the
          notifications panel in place, which is why Alerts is a button and not
          a Link. Create Mission is deliberately NOT in this row: it is the
          floating button below, because an action and a destination should
          not look alike. On main the row has three slots, without Challenges -
          see docs/challenges-branch.md. */}
      {!onOperatorSurface && (
